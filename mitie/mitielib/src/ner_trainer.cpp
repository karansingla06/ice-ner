...
// ----------------------------------------------------------------------------------------
    ...
    ) : beta(0.5), num_threads(4), num_c(300)
    {
        string classname;
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        train_ner_segment_classifier_objective (
            ...
            //unsigned long num_c_,   , num_c(num_c_)
            double beta_,
        ...
        ) const
        {
            ...
            //cout << "PART-II train_ner_segment_classifier_objective C:           "<< C << endl;
            //cout << "PART-II train_ner_segment_classifier_objective num threads: "<< num_threads << endl;
            //cout << "PART-II train_ner_segment_classifier_objective max iterations: " << max_iterations << endl;
            //trainer.be_verbose();
...
// ----------------------------------------------------------------------------------------
    ...
    ) const
    {
        ...
        //cout << "num training samples data : " << samples << endl;
        ...
        //trainer.be_verbose();
        cout << "C:           "<< num_c << endl;
        cout << "epsilon:     "<< 0.0001 << endl;
        cout << "num threads: "<< num_threads << endl;
        cout << "max iterations: " << 2000 << endl;
        ...
        if (count_of_least_common_label(labels) > 1)
        {
            ...
            double C = (double) num_c;
            //double *ptrGravity = const_cast<double*>(dGravity);
            //*ptrGravity = 10;
            const double min_C = 0.01;
            const double max_C = 5000;
            const double eps = 1;
            //cout << "PART-II-inside C:           "<< 200 << endl;
            //cout << "PART-II-inside epsilon:     "<< 0.01 << endl;
            //cout << "PART-II-inside min_C: "<< min_C << endl;
            //cout << "PART-II-inside max_C: " << max_C << endl;
            try
            {
...
// ----------------------------------------------------------------------------------------
    ...
    ) const
    {
        ...
        //cout << "num features data : " << tfe << endl;
