...
// ----------------------------------------------------------------------------------------
    ...
    void mitie_ner_trainer_set_num_c (
        mitie_ner_trainer* trainer_,
        unsigned long num_c
    )
    {
        checked_cast<ner_trainer>(trainer_).set_num_c(num_c);
    }

// ----------------------------------------------------------------------------------------

    unsigned long mitie_ner_trainer_get_num_c (
        const mitie_ner_trainer* trainer_
    )
    {
        return checked_cast<ner_trainer>(trainer_).get_num_c();
    }
