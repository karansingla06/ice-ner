...
class named_entity_extractor:
    ...
    def get_possible_ner_tags(self):
        ...
        return [to_default_str_type(_f.mitie_get_named_entity_tagstr(self.__obj, i)) for i in range(num)]
...
_f.mitie_ner_trainer_get_num_c.restype = ctypes.c_ulong
_f.mitie_ner_trainer_get_num_c.argtypes = ctypes.c_void_p,
...
_f.mitie_ner_trainer_set_num_c.restype = None
_f.mitie_ner_trainer_set_num_c.argtypes = ctypes.c_void_p, ctypes.c_ulong
...
class ner_trainer(object):
    ...
    @property
    def num_c(self):
        return _f.mitie_ner_trainer_get_num_c(self.__obj)

    @num_c.setter
    def num_c(self, value):
        print("setter num_c : ",value)
        _f.mitie_ner_trainer_set_num_c(self.__obj, value)
...
class total_word_feature_extractor:
    ...
    def get_feature_vector(self, word):
        ...
        _result = [result[i] for i in range(num_dimensions)]
