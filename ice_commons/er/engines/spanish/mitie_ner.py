...
from ice_commons.er.engines.mitie_ner import MitieDefaultNER, MitieCustomNER, MitieNER
...
mitie_hyper_parameter_c = app_config['C']

class MitieSpanishNER(MitieNER):
...
class MitieSpanishDefaultNER(MitieDefaultNER, MitieSpanishNER):

    def __init__(self, serviceid="DEFAULT"):
        super(MitieSpanishDefaultNER,self).__init__(serviceid)

    def load(self):
        user_dir = os.path.expanduser('~')
        mitieModelFilePath = os.path.join(user_dir, '.verbis/models/mitie', 'spanish', 'ner_model.dat')
...
class MitieSpanishCustomNER(MitieCustomNER, MitieSpanishNER):

    def __init__(self, serviceid=None):
        super(MitieSpanishCustomNER,self).__init__(serviceid)
    ...
    def __get_model_path(self):
        ...
        mitieModelFilePath = os.path.join(root_dir, 'mitie', 'spanish' , 'total_word_feature_extractor.dat')
