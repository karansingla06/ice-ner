...
import logging
from ice_commons.er.engines.crf_ner import CrfNER, CRFCustomNER
...
class CRFSpanishCustomNER(CRFCustomNER, CrfSpanishNER):

    def __init__(self, serviceid=None):
        super(CRFSpanishCustomNER, self).__init__(serviceid)
    ...
    def predict(self, text, original_text, pos):
        ...
        def entity_mapping(indx):
            ...
            if tag != "O":
                return {
                    "entity": input_text_pos_tag[indx][0],
                    "tag": tag,
